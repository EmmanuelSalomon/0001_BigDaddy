...
//determina la zona horaria predeterminada usada para todas las funciones de fecha/hora en un scrip
	...
	public function RealizaPedido(){
		if($this->cart->total_items()>0){
				...
				$configGmail = array(
					...
					'smtp_port' => 465,
					'smtp_user' => 'saavedraadrian886@gmail.com',
					'smtp_pass' => 'wendymiamor13',
					'mailtype'  => 'html',
					'charset'   => 'utf-8',
					'newline'   => "\r\n"
				);    
				$this->email->initialize($configGmail);
				$this->email->from('saavedraadrian886@gmail.com','Sistema Ecomerce');
