          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url();?>index.php/usuario/logueado"><i class="fa fa-circle-o">Bienvenido</i></a></li>
              </ul>
            </li>
			  <li class="active treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url();?>index.php/Usuario/getUsuario"><i class="fa fa-circle-o">Usuarios</i></a></li>
              </ul>
            </li>
			<li class="active treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url();?>index.php/Servicio/getServicio"><i class="fa fa-circle-o">Productos</i></a></li>
              </ul>
            </li>
			<li class="active treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>Comentarios</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url();?>index.php/Comentario/getComentario"><i class="fa fa-circle-o">Comentarios</i></a></li>
              </ul>
            </li>
