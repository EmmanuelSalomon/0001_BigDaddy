    ...
    <meta name="description" content="Punto de venta BIG DADDY">
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        <form id="loginform" name="loginform" class="form-horizontal" role="form">
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <input id="email" type="text" onblur='validarEmail(this.value);' class="form-control" name="email" >                                        
                            </div>
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                             ...
                             <div style="margin-top:10px" class="form-group">
                                ...
                                <center>
                                <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon glyphicon-hand-right"></span> Iniciar Sesión</button>
                                </center>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12 control">
                                    <div style="border-top: 3px solid#6C90D0; padding-top:20px; font-size:85%" ></div>
                                </div>
                            </div>    
                        </form>
                    </div>                     
