				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form name="formulario2" id="formulario2" >
							<input type="email" id="txtEmail" required name="txtEmail" placeholder="Correo" />
							<input type="password" id="txtPasswordE" required name="txtPasswordE" placeholder="Contraseña" />
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form name="formulario" id="formulario">
							...
							País:<input type="text" id="pais" name="pais" placeholder="País" required/>
							...
							Correo:<input type="email" id="email" onblur="validarEmail(this.value);" name="email" placeholder="Correo" required/>
							RFC:<input type="text" id="rfc" name="rfc" onblur="validarRFC(this.value);'" placeholder="RFC" required/>
							Teléfono:<input type="text" id="telefono" name="telefono" onkeypress="return  validarNumeros(event)" placeholder="Teléfono" required/>
							Contraseña:<input type="password" id="password" name="password" placeholder="Contraseña" required/>
